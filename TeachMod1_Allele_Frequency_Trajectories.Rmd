...
In this session, you will use allele frequency time series data from an experimental evolution study to carry out summary statistics and visualize allele frequency trajectories over time with different treatments.
...
The populations contain standing genetic variation for resistance to the organochloride insecticide dieldrin (first described here <https://pubmed.ncbi.nlm.nih.gov/8095336/>). The coordinates for the Rdl resistance mutation is Chr3L:9,148,264.
